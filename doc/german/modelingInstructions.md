...
- `flowDuration (number, optional)`: Hier kann abweichend von der flowDuration für die Animation einer Verbindung eine eigene Zeit in Sekunden definiert werden.  
